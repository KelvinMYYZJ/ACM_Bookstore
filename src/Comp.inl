...
int Comp::SingleComp<ValueType>::operator()(const ValueType& lhs, const ValueType& rhs)
{
	if (lhs < rhs)
		return -1;
	if (rhs < lhs)
...
bool Comp::CompToLess<Compare, ValueType>::operator()(const ValueType& lhs, const ValueType& rhs)
{
